...
> {
  ...
  public render() {
    return (
      <Dialog
        title="Move GlitchHub Desktop to the Applications folder?"
      ...
      >
        <DialogContent>
          <p>
            We've detected that you're not running GlitchHub Desktop from the
            Applications folder of your machine. This could cause problems with
            the app, including impacting your ability to sign in.
          </p>
          <p>
            Do you want to move GlitchHub Desktop to the Applications folder
    ...
    return (
      <DialogFooter>
        <OkCancelButtonGroup
          ...
          okButtonTitle="This will move GlitchHub Desktop to the Applications folder in your machine and restart the app."
