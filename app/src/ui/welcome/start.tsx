...
export class Start extends React.Component<IStartProps, {}> {
  public render() {
    return (
      <section
        id="start"
        aria-label="Welcome to GlitchHub Desktop"
        aria-describedby="start-description"
      >
        <div className="start-content">
          <h1 className="welcome-title">
            Welcome to <span>GlitchHub Desktop</span>
          </h1>
          {!this.props.loadingBrowserAuth ? (
            <>
              <p id="start-description" className="welcome-text">
                GlitchHub Desktop is a seamless way to contribute to projects on
        ...
        <div className="start-footer">
          ...
          <p>
            GlitchHub Desktop sends usage metrics to improve the product and
