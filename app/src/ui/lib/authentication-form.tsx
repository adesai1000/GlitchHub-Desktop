...
export const BrowserRedirectMessage =
  "Your browser will redirect you back to GlitchHub Desktop once you've signed in. If your browser asks for your permission to launch GlitchHub Desktop please allow it to."
